...
We evaluated the effectiveness and quality of COMPASS's adaptive explanation generation using two different case studies involving complex cyber-physical systems in the contruction and agricultural domains. .


# Evaluation results

Results are available in ```/evaluation-results/```. This contains the results for four different research questions:
